...
export const mockContacts: Contact[] = [
  ...
  { id: 'contact-2', firstName: 'Bob', lastName: 'Johnson', email: 'bob@example.com', phone: '555-5678', companyId: 'company-2', tags: ['Customer', 'Services'], description: 'Needs follow-up on Q2', createdAt: now, updatedAt: now },
...
export const mockDeals: Deal[] = [
  { id: 'deal-1', name: 'Innovatech Product A Deal', contactId: 'contact-1', companyId: 'company-1', stage: 'Opportunity', value: 50000, expectedCloseDate: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], tags: ['High Value', 'Q4 Target'], description: 'Initial discussion positive.', createdAt: now, updatedAt: now },
  { id: 'deal-2', name: 'Service Solutions Consulting Gig', contactId: 'contact-2', companyId: 'company-2', stage: 'Proposal Sent', value: 25000, expectedCloseDate: new Date(Date.now() + 15 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], tags: ['Quick Win'], description: 'Proposal sent, awaiting feedback.', createdAt: now, updatedAt: now },
