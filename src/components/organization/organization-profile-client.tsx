...
export function OrganizationProfileClient() {
  ...
  const fetchLocalOrganization = useCallback(
    async (orgId: string) => {
    ...
    return (
      <div>
        ...
        <Card>
          ...
          <CardContent>
            <p>Could not load organization details. It might not exist or an error occurred.</p>
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div>
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 p-6">
          <div>
            <h4 className="text-sm font-medium text-muted-foreground mb-1 flex items-center">
              <Building className="h-4 w-4 mr-2" /> Name
            </h4>
            <p className="text-sm">{organization.name}</p>
          </div>
          <div>
            <h4 className="text-sm font-medium text-muted-foreground mb-1 flex items-center">
              <DollarSign className="h-4 w-4 mr-2" /> Currency Symbol
            </h4>
          ...
          <div>
            <h4 className="text-sm font-medium text-muted-foreground mb-1 flex items-center">
              <Clock className="h-4 w-4 mr-2" /> Timezone
            </h4>
        ...
        <CardFooter className="p-6 pt-2 text-xs text-muted-foreground">
          <p>
            Last updated: <FormattedNoteTimestamp createdAt={organization.updatedAt} />
          </p>{" "}
          {/* Updated */}
        </CardFooter>
      </Card>
