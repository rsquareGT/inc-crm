...
export function CompanyDetailsClient({ companyId }: CompanyDetailsClientProps) {
  ...
  const accountManager = company?.accountManagerId
    ? allUsersList.find((u) => u.id === company.accountManagerId)
    : undefined;
  ...
  const sortedNotes = company?.notes
    ? [...company.notes].sort(
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-start">
                  <Skeleton className="h-5 w-5 mr-3 rounded-full mt-0.5" />
              ...
              <CardContent>
                <ScrollArea className="h-[250px]">
                  {Array.from({ length: 3 }).map((_, index) => (
                    <ActivityItemSkeleton key={`skeleton-company-activity-${index}`} />
                  ))}
                </ScrollArea>
              </CardContent>
            </Card>
            ...
            <Card className="flex flex-col">
              ...
              <CardContent className="flex-grow overflow-hidden p-2">
                <ScrollArea className="h-[200px]">
                  <div className="space-y-2">
                    {[...Array(2)].map((_, i) => (
                      <RelatedItemSkeleton key={`skeleton-contact-item-${i}`} />
                    ))}
                  </div>
                </ScrollArea>
              </CardContent>
            ...
            <Card className="flex flex-col">
              ...
              <CardContent className="flex-grow overflow-hidden p-2">
                <ScrollArea className="h-[200px]">
                  <div className="space-y-2">
                    {[...Array(2)].map((_, i) => (
                      <RelatedDealSkeleton key={`skeleton-deal-item-${i}`} />
                    ))}
                  </div>
                </ScrollArea>
              </CardContent>
                ...
                <ScrollArea className="h-[200px]">
                  <div className="space-y-2">
                    {contacts.map((contact) => (
                      <div
                        key={contact.id}
                        className="p-3 border rounded-md hover:shadow-md transition-shadow bg-card"
                      >
                        ...
                        <div className="flex justify-between items-start">
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              <DropdownMenuItem
                                onClick={() => handleDeleteRequest(deal.id, "deal", deal.name)}
                                className="text-destructive hover:!bg-destructive hover:!text-destructive-foreground"
                              >
                                <Trash2 className="mr-2 h-4 w-4" />
                                Delete
