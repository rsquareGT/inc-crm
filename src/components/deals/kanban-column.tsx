...
export function KanbanColumn({
  ...
  return (
    <div className={`flex-shrink-0 w-80 bg-secondary/50 rounded-lg p-1 border-t-4 ${stageColors[stage]}`}>
      <div className="p-3">
        <h3 className="text-md font-semibold mb-1">{stage} ({dealsInStage.length})</h3>
      ...
      <ScrollArea className="h-[calc(100vh-20rem)] pr-1"> {/* Adjust height as needed */}
        ...
        {dealsInStage.length === 0 && <p className="text-sm text-muted-foreground text-center py-4">No deals in this stage.</p>}
